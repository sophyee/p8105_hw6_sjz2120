...
I decided against including more potential predictors in `model_1` because of a lack of (non-conflicting) data, and because I wanted to start with a simpler model and adjust as necessary.
